...
Expense _expenseDeserialize(
  ...
  object.cloudId = reader.readString(offsets[2]);
  object.id = id;
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, double, QQueryOperations> latitudeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'latitude');
    });
  }

  QueryBuilder<Expense, double, QQueryOperations> longitudeProperty() {
    return QueryBuilder.apply(this, (query) {
